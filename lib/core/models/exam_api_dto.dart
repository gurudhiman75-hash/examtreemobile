...
class TestSectionDto {
  ...
  factory TestSectionDto.fromJson(Map<String, dynamic> json) => TestSectionDto(
    ...
    questions: _listOfMaps(
      json['questions'],
    ).map(QuestionDto.fromJson).toList(),
  );
}
...
class QuestionDto {
  ...
  factory QuestionDto.fromJson(Map<String, dynamic> json) => QuestionDto(
    ...
    explanationHi: _nullableString(
      json['explanationHi'] ?? json['explanation_hi'],
    ),
    textPa: _nullableString(json['textPa'] ?? json['text_pa']),
    optionsPa: _nullableStringList(json['optionsPa'] ?? json['options_pa']),
    explanationPa: _nullableString(
      json['explanationPa'] ?? json['explanation_pa'],
    ),
    seatingDiagram: _nullableMap(
      json['seatingDiagram'] ?? json['seating_diagram'],
    ),
    seatingExplanationFlow: _nullableMap(
      json['seatingExplanationFlow'] ?? json['seating_explanation_flow'],
    ),
    imageUrl: _nullableString(json['imageUrl'] ?? json['image_url']),
    questionType: _nullableString(
      json['questionType'] ?? json['question_type'],
    ),
    diSetId: json['diSetId'] != null || json['di_set_id'] != null
        ? _int(json['diSetId'] ?? json['di_set_id'])
        : null,
...
class TestDto {
  ...
  factory TestDto.fromJson(Map<String, dynamic> json) => TestDto(
    ...
    sections: _listOfMaps(
      json['sections'],
    ).map(TestSectionDto.fromJson).toList(),
    marksPerQuestion: json['marksPerQuestion'] == null
        ? null
        : _double(json['marksPerQuestion'], 1),
    negativeMarks: json['negativeMarks'] == null
        ? null
        : _double(json['negativeMarks']),
    languages: _stringList(json['languages']),
  );
  ...
  Exam toExam({
    ...
    final subcategoryDto = subcategoryId == null
        ? null
